...
class DataSequence(Sequence):
    ...
    def __init__(self, CellIds,BasePath,DataShape,TargetShape,BatchSize,XData,MinData,MaxData,Shuffle=True):
    ...
    def __data_generation(self, cellsList):
        ...
        X = np.array(self.XData.loc[cellsList])
        X = (X-self.Mins)
...
del trainXKmerData,trainXFeatData

trainFolds = pd.read_csv('/media/tavo/storage/0openproblems/data/seqs/MULTITrainFolds.csv') 
testFolds = pd.read_csv('/media/tavo/storage/0openproblems/data/seqs/MULTITestFolds.csv')
valData = pd.read_csv('/media/tavo/storage/0openproblems/data/seqs/MULTIValidation.csv')

normMins = pd.read_csv('/media/tavo/storage/0openproblems/data/seqs/MULTIMinsFolds.csv')
normMaxs = pd.read_csv('/media/tavo/storage/0openproblems/data/seqs/MULTIMaxsFolds.csv')
...
#Units = [4,8,16,32]#0.652
Units = [3,9,27]
#Units = [128,256,512]#0.652
